# Melissa Data Phone Object Linux Net Sample
...
2.  If you already have the latest DQS Release (ZIP), you can find the data file(s) and .so file(s) in there
	...
	- Copy all the .so file(s) mentioned above into the `MelissaDataPhoneObjectLinuxNETSample` project folder.
	
----------------------------------------

#### Configure Target Framework

Depending on your target .NET framework, you may need to configure the bash script. In order to do this, open up the `MelissaDataPhoneObjectLinuxNETSample.sh` for editing, proceed to the bottom of the script where you will find this section of code.
...
`chmod +x MelissaDataPhoneObjectLinuxNETSample.sh`
...
- Interactive 
	...
	```
	$ ./MelissaDataPhoneObjectLinuxNETSample.sh
	```
  For quiet mode:
  ```
  $ ./MelissaDataPhoneObjectLinuxNETSample.sh --quiet
  ```
- Command Line 
	...
	```
    $ ./MelissaDataPhoneObjectLinuxNETSample.sh --phone "800-635-4772" 
    $ ./MelissaDataPhoneObjectLinuxNETSample.sh --phone "800-635-4772" --license "<your_license_string>"
    ```
	For quiet mode:
    ```
    $ ./MelissaDataPhoneObjectLinuxNETSample.sh --phone "800-635-4772" --quiet
    $ ./MelissaDataPhoneObjectLinuxNETSample.sh --phone "800-635-4772" --license "<your_license_string>" --quiet
    ```
